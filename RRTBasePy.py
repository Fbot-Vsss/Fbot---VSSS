...
class RRTGraph:
    ...
    def makeobs(self):
        ...
        for i in range(0, self.obsNum):
            blue_0 = FIRALib.AzulCar(0)
            blue_1 = FIRALib.AzulCar(1)
            blue_2 = FIRALib.AzulCar(2)
            yellow_1 = FIRALib.amareloCar(1)
            yellow_2 = FIRALib.amareloCar(2)
            blue_0 = (428+(blue_0[0]/2)*1000, 305 - (blue_0[1]/2)*1000,)
            blue_1 = (-50 + 428+(blue_1[0]/2)*1000, -50 + 305 - (blue_1[1]/2)*1000,self.obsDim, self.obsDim)
            blue_2 = (428+(blue_2[0]/2)*1000, 305 - (blue_2[1]/2)*1000,self.obsDim, self.obsDim)
            yellow_1 = (428+(yellow_1[0]/2)*1000, 305 - (yellow_1[1]/2)*1000,self.obsDim, self.obsDim)
            yellow_2 = (428+(yellow_2[0]/2)*1000, 305 - (yellow_2[1]/2)*1000,self.obsDim, self.obsDim)
            rectang = None
            startgoalcol = True
            borda1 = (0, 0, 50, 203)
            borda2 = (0, 406, 50, 610)
